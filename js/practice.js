(() => {
  ...
  let enterNewScene = false; // 새로운 scene에 들어온 순간
  let acc = 0.1;
    ...
    switch (currentScene) {
      ...
      case 3:
        ...
        if (!values.rectStartY) {
          ...
          values.rectStartY = values.rectStartY =
